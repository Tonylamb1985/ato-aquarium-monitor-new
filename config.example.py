"""
ATO Aquarium Monitor - Configuration File
...
# Temperature sensor uses GPIO 4 (Pin 7) - configured in /boot/config.txt
...
# ============================================================================
# Adjust these based on your fish species requirements
